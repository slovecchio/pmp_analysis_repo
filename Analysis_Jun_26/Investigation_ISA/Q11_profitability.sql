-- The US HFBs with strong sales and low gross margin from 2026-05-01 to 2026-05-31 are shown below, with HFB number, HFB name, Created Net Sales by year in thousands, Created Net Sales index vs last year, GP0 and budget sales in thousands, GM0 %, average HFB GM0 %, and GM0 gap in percentage points.
